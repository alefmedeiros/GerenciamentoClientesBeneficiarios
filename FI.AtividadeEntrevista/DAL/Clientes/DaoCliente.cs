...
namespace FI.AtividadeEntrevista.DAL
{
    ...
    internal class DaoCliente : AcessoDados
    {
        ...
        internal long Incluir(DML.Cliente cliente)
        {
            ...
            parametros.Add(new System.Data.SqlClient.SqlParameter("CPF", cliente.CPF)); // ✅ ADICIONADO
        ...
        /// <summary>
        /// Verifica se já existe um cliente com o CPF informado, excluindo o próprio cliente na alteração
        /// </summary>
        /// <param name="CPF">CPF do cliente</param>
        /// <param name="Id">Id do cliente</param>
        internal bool VerificarExistencia(string CPF, long Id) // ✅ ADICIONADO (Sobrecarga para alteração)
        {
            List<System.Data.SqlClient.SqlParameter> parametros = new List<System.Data.SqlClient.SqlParameter>();
        ...
        private List<DML.Cliente> Converter(DataSet ds)
        {
            ...
            if (ds != null && ds.Tables != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                foreach (DataRow row in ds.Tables[0].Rows)
                {
                    ...
                    cli.CPF = row.Field<string>("CPF"); // ✅ ADICIONADO
                    lista.Add(cli);
                }
            }
